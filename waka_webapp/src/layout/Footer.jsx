        ...
        <div className="bottom-navigation-bar">
            <div className="tf-container">
                <ul className="tf-navigation-bar">
                    <li><a className="fw_4 d-flex justify-content-center align-items-center flex-column" href="/traffic" previewlistener="true"><i className="icon-history" /> Traffic</a> </li>
